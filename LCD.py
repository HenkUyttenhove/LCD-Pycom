...
class CharLCD(object):
    ...
    # Command constants
    LCD_CLEAR = 0x01  # clear LCD_DISPLAYMOVE
    LCD_CURSORSHIFT = 0x10  # move cursor left
    LCD_DISPLAYCONTROL = 0x08  # display off, cursor off
    ...
    def __init__(self, rs="P6", en="P7", d4="P22", d5="P21", d6="P20", d7="P19",
                 cols=16, rows=2):
        """Constructor for LCD.
